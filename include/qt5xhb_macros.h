...
#define OPBOOL( n, v )                                      static_cast< bool >( ISNIL( n ) ? v : hb_parl( n ) )
#define OPCHAR( n, v )                                      static_cast< char >( ISNIL( n ) ? v : hb_parni( n ) )
#define OPUSHORT( n, v )                                    static_cast< ushort >( ISNIL( n ) ? v : hb_parni( n ) )
#define OPINT( n, v )                                       static_cast< int >( ISNIL( n ) ? v : hb_parni( n ) )
#define OPUINT( n, v )                                      static_cast< uint >( ISNIL( n ) ? v : hb_parni( n ) )
#define OPFLOAT( n, v )                                     static_cast< float >( ISNIL( n ) ? v : hb_parnd( n ) )
#define OPDOUBLE( n, v )                                    static_cast< double >( ISNIL( n ) ? v : hb_parnd( n ) )
#define OPQREAL( n, v )                                     static_cast< qreal >( ISNIL( n ) ? v : hb_parnd( n ) )
...
#define OPQINT8( n, v )                                     static_cast< qint8 >( ISNIL( n ) ? v : hb_parni( n ) )
#define OPQINT16( n, v )                                    static_cast< qint16 >( ISNIL( n ) ? v : hb_parni( n ) )
#define OPQINT32( n, v )                                    static_cast< qint32 >( ISNIL( n ) ? v : hb_parni( n ) )
#define OPQINT64( n, v )                                    static_cast< qint64 >( ISNIL( n ) ? v : hb_parnll( n ) )
#define OPQUINT8( n, v )                                    static_cast< quint8 >( ISNIL( n ) ? v : hb_parni( n ) )
#define OPQUINT16( n, v )                                   static_cast< quint16 >( ISNIL( n ) ? v : hb_parni( n ) )
#define OPQUINT32( n, v )                                   static_cast< quint32 >( ISNIL( n ) ? v : hb_parni( n ) )
#define OPQUINT64( n, v )                                   static_cast< quint64 >( ISNIL( n ) ? v : hb_parnll( n ) )
#define OPGLBOOLEAN( n, v )                                 static_cast< GLboolean >( ISNIL( n ) ? v : hb_parl( n ) )
#define OPGLINT( n, v )                                     static_cast< GLint >( ISNIL( n ) ? v : hb_parni( n ) )
#define OPGLUINT( n, v )                                    static_cast< GLuint >( ISNIL( n ) ? v : hb_parni( n ) )
#define OPGLUINT64( n, v )                                  static_cast< GLuint64 >( ISNIL( n ) ? v : hb_parnll( n ) )
#define OPGLFLOAT( n, v )                                   static_cast< GLfloat >( ISNIL( n ) ? v : hb_parnd( n ) )
#define OPGLCLAMPF( n, v )                                  static_cast< GLclampf >( ISNIL( n ) ? v : hb_parnd( n ) )
#define OPGLENUM( n, v )                                    static_cast< GLenum >( ISNIL( n ) ? v : hb_parni( n ) )
#define OPGLBITFIELD( n, v )                                static_cast< GLbitfield >( ISNIL( n ) ? v : hb_parni( n ) )
#define OPGLSIZEI( n, v )                                   static_cast< GLsizei >( ISNIL( n ) ? v : hb_parni( n ) )
