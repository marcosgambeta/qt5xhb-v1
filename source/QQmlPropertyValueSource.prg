...
CLASS QQmlPropertyValueSource
   ...
   DATA pointer
   DATA class_id INIT Class_Id_QQmlPropertyValueSource
...
{
#if (QT_VERSION >= QT_VERSION_CHECK(5,0,0))
  QQmlPropertyValueSource * obj = (QQmlPropertyValueSource *) hb_itemGetPtr( hb_objSendMsg( hb_stackSelfItem(), "POINTER", 0 ) );
  if( obj )
  {
    delete obj;
    obj = NULL;
...
{
  QQmlPropertyValueSource * obj = (QQmlPropertyValueSource *) _qtxhb_itemGetPtrStackSelfItem();
  if( obj )
  {
