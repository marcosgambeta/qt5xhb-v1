...
#define GET_PTR_FROM_SELF(p) QTextLayout *p = static_cast<QTextLayout *>(Qt5xHb::itemGetPtrStackSelfItem())
...
HB_FUNC_STATIC(QTEXTLAYOUT_NEW)
{
  if (ISNUMPAR(0)) {
    ...
    Qt5xHb::returnNewObject(obj, true);
  } else if (ISBETWEEN(2, 3) && ISQSTRING(1) && ISQFONT(2) && ISOBJECTORNIL(3)) {
