...
#define GET_PTR_FROM_SELF(p) QIcon *p = (QIcon *)Qt5xHb::itemGetPtrStackSelfItem()
...
#endif
      RQSIZE(obj->actualSize(*PQSIZE(1), HB_ISNIL(2) ? (QIcon::Mode)QIcon::Normal : (QIcon::Mode)hb_parni(2),
...
HB_FUNC_STATIC(QICON_ADDFILE)
{
  ...
  if (obj != NULL) {
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    if (ISBETWEEN(1, 4) && ISQSTRING(1) && ISQSIZEORNIL(2) && ISNUMORNIL(3) &&
        ISNUMORNIL(4)) {
#endif
...
HB_FUNC_STATIC(QICON_PIXMAP)
{
  if (ISBETWEEN(1, 3) && ISQSIZE(1) && ISNUMORNIL(2) && ISNUMORNIL(3)) {
    ...
    if (obj != NULL) {
      RQPIXMAP(obj->pixmap(*PQSIZE(1), HB_ISNIL(2) ? (QIcon::Mode)QIcon::Normal : (QIcon::Mode)hb_parni(2),
                                  HB_ISNIL(3) ? (QIcon::State)QIcon::Off : (QIcon::State)hb_parni(3)));
    }
    ...
    if (obj != NULL) {
      RQPIXMAP(obj->pixmap(PINT(1), PINT(2), HB_ISNIL(3) ? (QIcon::Mode)QIcon::Normal : (QIcon::Mode)hb_parni(3),
                                  HB_ISNIL(4) ? (QIcon::State)QIcon::Off : (QIcon::State)hb_parni(4)));
    }
    ...
    if (obj != NULL) {
      RQPIXMAP(obj->pixmap(PINT(1), HB_ISNIL(2) ? (QIcon::Mode)QIcon::Normal : (QIcon::Mode)hb_parni(2),
                                  HB_ISNIL(3) ? (QIcon::State)QIcon::Off : (QIcon::State)hb_parni(3)));
    }
  } else {
    hb_errRT_BASE(EG_ARG, 3012, NULL, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
