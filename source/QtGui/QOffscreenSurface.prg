...
#define GET_PTR_FROM_SELF(p)                                                                                           \
  QOffscreenSurface *p = qobject_cast<QOffscreenSurface *>(Qt5xHb::getQObjectPointerFromSelfItem())
...
#define CONNECT_SIGNAL(signal) QOffscreenSurfaceSlots_connect_signal(signal, signal)
