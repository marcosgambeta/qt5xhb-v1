...
CLASS QAccessibleValueInterface
   ...
   DATA pointer
   DATA class_id INIT Class_Id_QAccessibleValueInterface
...
{
#if (QT_VERSION >= QT_VERSION_CHECK(5,0,0))
  QAccessibleValueInterface * obj = (QAccessibleValueInterface *) hb_itemGetPtr( hb_objSendMsg( hb_stackSelfItem(), "POINTER", 0 ) );
  if( obj )
  {
    delete obj;
    obj = NULL;
