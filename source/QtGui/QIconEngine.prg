...
#define GET_PTR_FROM_SELF(p) QIconEngine *p = static_cast<QIconEngine *>(Qt5xHb::itemGetPtrStackSelfItem())
...
HB_FUNC_STATIC(QICONENGINE_PIXMAP)
{
  ...
  if (obj != NULL) {
    ...
    if (ISNUMPAR(3) && ISQSIZE(1) && HB_ISNUM(2) && HB_ISNUM(3)) {
#endif
      RQPIXMAP(obj->pixmap(*PQSIZE(1), (QIcon::Mode)hb_parni(2), (QIcon::State)hb_parni(3)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, NULL, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
    }
