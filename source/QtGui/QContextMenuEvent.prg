...
HB_FUNC_STATIC( QCONTEXTMENUEVENT_NEW1 )
{
  int par1 = hb_parni(1);
  int par4 = hb_parni(4);
  QContextMenuEvent * o = new QContextMenuEvent ( (QContextMenuEvent::Reason) par1, *PQPOINT(2), *PQPOINT(3), (Qt::KeyboardModifiers) par4 );
...
{
  int par1 = hb_parni(1);
  QContextMenuEvent * o = new QContextMenuEvent ( (QContextMenuEvent::Reason) par1, *PQPOINT(2), *PQPOINT(3) );
  _qt5xhb_storePointerAndFlag( o, false );
}
...
{
  int par1 = hb_parni(1);
  QContextMenuEvent * o = new QContextMenuEvent ( (QContextMenuEvent::Reason) par1, *PQPOINT(2) );
  _qt5xhb_storePointerAndFlag( o, false );
}
