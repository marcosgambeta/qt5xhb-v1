...
#define GET_PTR_FROM_SELF(p) QIntValidator *p = qobject_cast<QIntValidator *>(Qt5xHb::getQObjectPointerFromSelfItem())
...
#define CONNECT_SIGNAL(signal) QIntValidatorSlots_connect_signal(signal, signal)
