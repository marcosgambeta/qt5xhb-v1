...
#define GET_PTR_FROM_SELF(p) QBitmap *p = (QBitmap *)Qt5xHb::itemGetPtrStackSelfItem()
...
#endif
    RQBITMAP(QBitmap::fromImage(*PQIMAGE(1), HB_ISNIL(2) ? (Qt::ImageConversionFlags)Qt::AutoColor
