...
#define GET_PTR_FROM_SELF(p) QDrag *p = qobject_cast<QDrag *>(Qt5xHb::getQObjectPointerFromSelfItem())
...
#endif
      RQPIXMAP(obj->dragCursor((Qt::DropAction)hb_parni(1)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, NULL, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
    }
...
{
  CONNECT_SIGNAL("targetChanged(QObject*)");
}
