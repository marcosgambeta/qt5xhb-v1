...
CLASS QAccessibleImageInterface
   ...
   DATA pointer
   //DATA class_id INIT Class_Id_QAccessibleImageInterface
...
{
  QAccessibleImageInterface * obj = (QAccessibleImageInterface *) hb_itemGetPtr( hb_objSendMsg( hb_stackSelfItem(), "POINTER", 0 ) );
  if( obj )
  {
    delete obj;
    obj = NULL;
