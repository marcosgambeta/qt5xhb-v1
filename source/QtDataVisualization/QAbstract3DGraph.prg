...
#define GET_PTR_FROM_SELF(p)                                                                                           \
  QAbstract3DGraph *p = qobject_cast<QAbstract3DGraph *>(Qt5xHb::getQObjectPointerFromSelfItem())
