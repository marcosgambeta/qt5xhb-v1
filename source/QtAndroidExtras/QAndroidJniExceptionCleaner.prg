...
/*
QAndroidJniExceptionCleaner( QAndroidJniExceptionCleaner::OutputMode outputMode = QAndroidJniExceptionCleaner::::Silent )
*/
HB_FUNC_STATIC( QANDROIDJNIEXCEPTIONCLEANER_NEW )
{
  ...
  {
    QAndroidJniExceptionCleaner * obj = new QAndroidJniExceptionCleaner( HB_ISNIL(1)? (QAndroidJniExceptionCleaner::OutputMode) QAndroidJniExceptionCleaner::::Silent : (QAndroidJniExceptionCleaner::OutputMode) hb_parni(1) );
