...
HB_FUNC_STATIC( QINPUTDIALOG_GETDOUBLE )
{
  ...
  hb_retnd( QInputDialog::getDouble ( par1, PQSTRING(2), PQSTRING(3), par4, par5, par6, (int) ISNIL(7)? 1 : hb_parni(7), &par8,  (Qt::WindowFlags) par9 ) );
  hb_storl( par8, 8 );
}
...
HB_FUNC_STATIC( QINPUTDIALOG_GETINT )
{
  ...
  bool par8;
  int par9 = ISNIL(9)? (int) 0 : hb_parni(9);
  hb_retni( QInputDialog::getInt ( par1, PQSTRING(2), PQSTRING(3), (int) ISNIL(4)? 0 : hb_parni(4), (int) ISNIL(5)? -2147483647 : hb_parni(5), (int) ISNIL(6)? 2147483647 : hb_parni(6), (int) ISNIL(7)? 1 : hb_parni(7), &par8,  (Qt::WindowFlags) par9 ) );
  hb_storl( par8, 8 );
}
...
HB_FUNC_STATIC( QINPUTDIALOG_GETITEM )
{
  ...
  hb_retc( (const char *) QInputDialog::getItem ( par1, PQSTRING(2), PQSTRING(3), par4, (int) ISNIL(5)? 0 : hb_parni(5), (bool) ISNIL(6)? true : hb_parl(6), &par7,  (Qt::WindowFlags) par8,  (Qt::InputMethodHints) par9 ).toLatin1().data() );
  hb_storl( par7, 7 );
}
...
HB_FUNC_STATIC( QINPUTDIALOG_GETTEXT )
{
  ...
  hb_retc( (const char *) QInputDialog::getText ( par1, PQSTRING(2), PQSTRING(3),  (QLineEdit::EchoMode) par4, par5, &par6,  (Qt::WindowFlags) par7,  (Qt::InputMethodHints) par8 ).toLatin1().data() );
  hb_storl( par6, 6 );
}
...
HB_FUNC_STATIC( QINPUTDIALOG_GETMULTILINETEXT )
{
  ...
  hb_retc( (const char *) QInputDialog::getMultiLineText ( par1, PQSTRING(2), PQSTRING(3), par4, &par5,  (Qt::WindowFlags) par6,  (Qt::InputMethodHints) par7 ).toLatin1().data() );
  hb_storl( par5, 5 );
}
