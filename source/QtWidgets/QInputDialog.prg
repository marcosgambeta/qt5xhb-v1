...
minValue = -2147483647, double maxValue = 2147483647, int decimals = 1, bool * ok = 0, Qt::WindowFlags flags = 0 )
*/
HB_FUNC_STATIC(QINPUTDIALOG_GETDOUBLE)
{
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
  if (ISBETWEEN(3, 9) && ISQWIDGET(1) && ISQSTRING(2) && ISQSTRING(3) && ISNUMORNIL(4) &&
...
-2147483647, int maxValue = 2147483647, int step = 1, bool * ok = 0, Qt::WindowFlags flags = 0 )
*/
...
current = 0, bool editable = true, bool * ok = 0, Qt::WindowFlags flags = 0, Qt::InputMethodHints inputMethodHints =
Qt::ImhNone )
*/
HB_FUNC_STATIC(QINPUTDIALOG_GETITEM)
{
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
  if (ISBETWEEN(4, 9) && ISQWIDGET(1) && ISQSTRING(2) && ISQSTRING(3) && HB_ISARRAY(4) &&
      ISNUMORNIL(5) && ISLOGORNIL(6) && ISLOGORNIL(7) &&
      ISNUMORNIL(8) && ISNUMORNIL(9)) {
#endif
    bool par7;
    RQSTRING(
        QInputDialog::getItem(PQWIDGET(1), PQSTRING(2), PQSTRING(3), PQSTRINGLIST(4), OPINT(5, 0), OPBOOL(6, true),
...
QLineEdit::Normal, const QString &text = QString(), bool * ok = 0, Qt::WindowFlags flags = 0, Qt::InputMethodHints
inputMethodHints = Qt::ImhNone )
*/
HB_FUNC_STATIC(QINPUTDIALOG_GETTEXT)
{
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
  if (ISBETWEEN(3, 8) && ISQWIDGET(1) && ISQSTRING(2) && ISQSTRING(3) && ISNUMORNIL(4) &&
      ISQSTRINGORNIL(5) && ISLOGORNIL(6) && ISNUMORNIL(7) &&
      ISNUMORNIL(8)) {
#endif
    bool par6;
...
QString(), bool * ok = 0, Qt::WindowFlags flags = 0, Qt::InputMethodHints inputMethodHints = Qt::ImhNone )
*/
HB_FUNC_STATIC(QINPUTDIALOG_GETMULTILINETEXT)
{
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
  if (ISBETWEEN(3, 7) && ISQWIDGET(1) && ISQSTRING(2) && ISQSTRING(3) && ISQSTRINGORNIL(4) &&
    ...
    RQSTRING(QInputDialog::getMultiLineText(PQWIDGET(1), PQSTRING(2), PQSTRING(3), OPQSTRING(4, QString()), &par5,
                                            ...
                                            HB_ISNIL(7) ? (Qt::InputMethodHints)Qt::ImhNone
