...
HB_FUNC_STATIC( QBOXLAYOUT_ADDLAYOUT )
{
  ...
  if( obj )
  {
    ...
    if( ISBETWEEN(1,2) && ISQLAYOUT(1) && (ISNUM(2)||HB_ISNIL(2)) )
    {
#endif
...
HB_FUNC_STATIC( QBOXLAYOUT_ADDWIDGET )
{
  ...
  {
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    if( ISBETWEEN(1,3) && ISQWIDGET(1) && (ISNUM(2)||HB_ISNIL(2)) && (ISNUM(3)||HB_ISNIL(3)) )
    {
#endif
...
HB_FUNC_STATIC( QBOXLAYOUT_INSERTLAYOUT )
{
  ...
  {
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    if( ISBETWEEN(2,3) && HB_ISNUM(1) && ISQLAYOUT(2) && (ISNUM(3)||HB_ISNIL(3)) )
    {
#endif
...
HB_FUNC_STATIC( QBOXLAYOUT_INSERTWIDGET )
{
  ...
  {
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    if( ISBETWEEN(2,4) && HB_ISNUM(1) && ISQWIDGET(2) && (ISNUM(3)||HB_ISNIL(3)) && (ISNUM(4)||HB_ISNIL(4)) )
    {
#endif
