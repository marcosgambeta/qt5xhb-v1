...
#define GET_PTR_FROM_SELF(p) QSqlDriver *p = (QSqlDriver *)Qt5xHb::itemGetPtrStackSelfItem()
...
{
  CONNECT_SIGNAL("notification(QString,QSqlDriver::NotificationSource,QVariant)");
}
