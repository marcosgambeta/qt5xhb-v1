...
CLASS QIRProximityFilter INHERIT QSensorFilter
   ...
   DATA class_id INIT Class_Id_QIRProximityFilter
...
{
#if (QT_VERSION >= QT_VERSION_CHECK(5,1,0))
  QIRProximityFilter * obj = (QIRProximityFilter *) _qtxhb_itemGetPtrStackSelfItem();
  if( obj )
  {
    QIRProximityReading * par1 = (QIRProximityReading *) _qtxhb_itemGetPtr(1);
