...
{
#if (QT_VERSION >= QT_VERSION_CHECK(5,1,0))
  QRotationFilter * obj = (QRotationFilter *) hb_itemGetPtr( hb_objSendMsg( hb_stackSelfItem(), "POINTER", 0 ) );
  if( obj )
  {
    delete obj;
    obj = NULL;
...
{
#if (QT_VERSION >= QT_VERSION_CHECK(5,1,0))
  QRotationFilter * obj = (QRotationFilter *) _qtxhb_itemGetPtrStackSelfItem();
  if( obj )
  {
    QRotationReading * par1 = (QRotationReading *) _qtxhb_itemGetPtr(1);
