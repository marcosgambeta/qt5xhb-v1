...
HB_FUNC_STATIC( QNETWORKPROXYQUERY_NEW )
{
  ...
  else if( ISBETWEEN(2,4) && ISCHAR(1) && ISNUM(2) && (ISCHAR(3)||ISNIL(3)) && ISOPTNUM(4) )
  {
    HB_FUNC_EXEC( QNETWORKPROXYQUERY_NEW3 );
  }
  else if( ISBETWEEN(1,3) && ISNUM(1) && (ISCHAR(2)||ISNIL(2)) && ISOPTNUM(3) )
  {
  ...
  else if( ISBETWEEN(3,5) && ISQNETWORKCONFIGURATION(1) && ISCHAR(2) && ISNUM(3) && (ISCHAR(4)||ISNIL(4)) && ISOPTNUM(5) )
  {
    HB_FUNC_EXEC( QNETWORKPROXYQUERY_NEW7 );
  }
  else if( ISBETWEEN(2,4) && ISQNETWORKCONFIGURATION(1) && ISNUM(2) && (ISCHAR(3)||ISNIL(3)) && ISOPTNUM(4) )
  {
