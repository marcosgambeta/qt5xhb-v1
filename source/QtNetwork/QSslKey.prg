  ...
  if (ISNUMPAR(0)) {
    ...
    */
    ...
    Qt5xHb::returnNewObject(obj, true);
           ...
           ISNUMORNIL(4) && ISQBYTEARRAYORNIL(5)) {
    /*
...
#endif
      RQBYTEARRAY(obj->toDer(HB_ISNIL(1) ? QByteArray() : *(QByteArray *)Qt5xHb::itemGetPtr(1)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, NULL, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
    }
...
HB_FUNC_STATIC(QSSLKEY_TOPEM)
{
  ...
  if (obj != NULL) {
    ...
    if (ISBETWEEN(0, 1) && ISQBYTEARRAYORNIL(1)) {
#endif
      RQBYTEARRAY(obj->toPem(HB_ISNIL(1) ? QByteArray() : *(QByteArray *)Qt5xHb::itemGetPtr(1)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, NULL, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
    }
