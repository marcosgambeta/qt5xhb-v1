...
#define GET_PTR_FROM_SELF(p)                                                                                           \
  QHXYModelMapper *p = qobject_cast<QHXYModelMapper *>(Qt5xHb::getQObjectPointerFromSelfItem())
...
#define CONNECT_SIGNAL(signal) QHXYModelMapperSlots_connect_signal(signal, signal)
