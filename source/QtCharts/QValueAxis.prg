...
#define GET_PTR_FROM_SELF(p) QValueAxis *p = qobject_cast<QValueAxis *>(Qt5xHb::getQObjectPointerFromSelfItem())
...
#define CONNECT_SIGNAL(signal) QValueAxisSlots_connect_signal(signal, signal)
