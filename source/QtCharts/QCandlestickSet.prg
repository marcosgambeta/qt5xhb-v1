...
#define GET_PTR_FROM_SELF(p)                                                                                           \
  QCandlestickSet *p = qobject_cast<QCandlestickSet *>(Qt5xHb::getQObjectPointerFromSelfItem())
...
HB_FUNC_STATIC(QCANDLESTICKSET_NEW)
{
  if (ISBETWEEN(0, 2) && ISNUMORNIL(1) && ISQOBJECTORNIL(2)) {
    ...
    Qt5xHb::returnNewObject(obj, false);
             ...
             ISQOBJECTORNIL(6)) {
    // QCandlestickSet( qreal open, qreal high, qreal low, qreal close, qreal timestamp = 0.0, QObject * parent =
    // nullptr )
#if (QT_VERSION >= QT_VERSION_CHECK(5, 8, 0))
    QCandlestickSet *obj =
...
#define CONNECT_SIGNAL(signal) QCandlestickSetSlots_connect_signal(signal, signal)
...
{
#if (QT_VERSION >= QT_VERSION_CHECK(5, 8, 0))
  CONNECT_SIGNAL("timestampChanged()");
#else
  hb_retl(false);
#endif
}
