...
#define GET_PTR_FROM_SELF(p) QLegendMarker *p = qobject_cast<QLegendMarker *>(Qt5xHb::getQObjectPointerFromSelfItem())
...
#define CONNECT_SIGNAL(signal) QLegendMarkerSlots_connect_signal(signal, signal)
