...
#define GET_PTR_FROM_SELF(p) QAxObject *p = qobject_cast<QAxObject *>(Qt5xHb::getQObjectPointerFromSelfItem())
...
HB_FUNC_STATIC(QAXOBJECT_DYNAMICCALL)
{
  if (ISBETWEEN(1, 9) && HB_ISCHAR(1) && ISQVARIANTORNIL(2) && ISQVARIANTORNIL(3) && ISQVARIANTORNIL(4) &&
    ...
    if (obj != NULL) {
      RQVARIANT(obj->dynamicCall(PCONSTCHAR(1), HB_ISNIL(2) ? QVariant() : *(QVariant *)Qt5xHb::itemGetPtr(2),
...
#define CONNECT_SIGNAL(signal) QAxObjectSlots_connect_signal(signal, signal)
