...
{
  QQuickWebEngineScriptSlots_connect_signal("injectionPointChanged(QQuickWebEngineScript::InjectionPoint)",
                                            "injectionPointChanged(QQuickWebEngineScript::InjectionPoint)");
}
...
{
  QQuickWebEngineScriptSlots_connect_signal("worldIdChanged(QQuickWebEngineScript::ScriptWorldId)",
                                            "worldIdChanged(QQuickWebEngineScript::ScriptWorldId)");
}
