...
HB_FUNC( QWEBENGINEPAGE_ONFEATUREPERMISSIONREQUESTED )
{
  ...
  {
    QObject* object = (QObject*) hb_itemGetPtr( hb_objSendMsg( hb_stackSelfItem(), "POINTER", 0 ) );
    QString signal = "featurePermissionRequested(QUrl,QWebEnginePage::Feature)";
    bool connected = Signals_is_signal_connected( object, signal );
    if( !connected )
    {
      PHB_ITEM codeblock = hb_itemNew( hb_param( 1, HB_IT_BLOCK | HB_IT_SYMBOL ) );
      if( codeblock )
      {
        ret = object->connect( object, SIGNAL(featurePermissionRequested(QUrl,QWebEnginePage::Feature)), s, SLOT(featurePermissionRequested(QUrl,QWebEnginePage::Feature)) );
        if( ret )
        {
          Signals_connect_signal( object, signal, codeblock ); // se conectado, adiciona
          hb_retl(ret);
  ...
  else if( hb_pcount() == 0 )
  {
    QObject* object = (QObject*) hb_itemGetPtr( hb_objSendMsg( hb_stackSelfItem(), "POINTER", 0 ) );
    QString signal = "featurePermissionRequested(QUrl,QWebEnginePage::Feature)";
    ret = object->disconnect(object, SIGNAL(featurePermissionRequested(QUrl,QWebEnginePage::Feature)), s, SLOT(featurePermissionRequested(QUrl,QWebEnginePage::Feature)) );
    if( ret )
    {
      Signals_disconnect_signal( object, signal );
      hb_retl(true);
...
HB_FUNC( QWEBENGINEPAGE_ONFEATUREPERMISSIONREQUESTCANCELED )
{
  ...
  {
    QObject* object = (QObject*) hb_itemGetPtr( hb_objSendMsg( hb_stackSelfItem(), "POINTER", 0 ) );
    QString signal = "featurePermissionRequestCanceled(QUrl,QWebEnginePage::Feature)";
    bool connected = Signals_is_signal_connected( object, signal );
    if( !connected )
    {
      PHB_ITEM codeblock = hb_itemNew( hb_param( 1, HB_IT_BLOCK | HB_IT_SYMBOL ) );
      if( codeblock )
      {
        ret = object->connect( object, SIGNAL(featurePermissionRequestCanceled(QUrl,QWebEnginePage::Feature)), s, SLOT(featurePermissionRequestCanceled(QUrl,QWebEnginePage::Feature)) );
        if( ret )
        {
          Signals_connect_signal( object, signal, codeblock ); // se conectado, adiciona
          hb_retl(ret);
  ...
  else if( hb_pcount() == 0 )
  {
    QObject* object = (QObject*) hb_itemGetPtr( hb_objSendMsg( hb_stackSelfItem(), "POINTER", 0 ) );
    QString signal = "featurePermissionRequestCanceled(QUrl,QWebEnginePage::Feature)";
    ret = object->disconnect(object, SIGNAL(featurePermissionRequestCanceled(QUrl,QWebEnginePage::Feature)), s, SLOT(featurePermissionRequestCanceled(QUrl,QWebEnginePage::Feature)) );
    if( ret )
    {
      Signals_disconnect_signal( object, signal );
      hb_retl(true);
...
HB_FUNC( QWEBENGINEPAGE_ONAUTHENTICATIONREQUIRED )
{
  ...
  {
    QObject* object = (QObject*) hb_itemGetPtr( hb_objSendMsg( hb_stackSelfItem(), "POINTER", 0 ) );
    QString signal = "authenticationRequired(QUrl,QAuthenticator*)";
    bool connected = Signals_is_signal_connected( object, signal );
    if( !connected )
    {
      PHB_ITEM codeblock = hb_itemNew( hb_param( 1, HB_IT_BLOCK | HB_IT_SYMBOL ) );
      if( codeblock )
      {
        ret = object->connect( object, SIGNAL(authenticationRequired(QUrl,QAuthenticator*)), s, SLOT(authenticationRequired(QUrl,QAuthenticator*)) );
        if( ret )
        {
          Signals_connect_signal( object, signal, codeblock ); // se conectado, adiciona
          hb_retl(ret);
  ...
  else if( hb_pcount() == 0 )
  {
    QObject* object = (QObject*) hb_itemGetPtr( hb_objSendMsg( hb_stackSelfItem(), "POINTER", 0 ) );
    QString signal = "authenticationRequired(QUrl,QAuthenticator*)";
    ret = object->disconnect(object, SIGNAL(authenticationRequired(QUrl,QAuthenticator*)), s, SLOT(authenticationRequired(QUrl,QAuthenticator*)) );
    if( ret )
    {
      Signals_disconnect_signal( object, signal );
      hb_retl(true);
...
HB_FUNC( QWEBENGINEPAGE_ONPROXYAUTHENTICATIONREQUIRED )
{
  ...
  {
    QObject* object = (QObject*) hb_itemGetPtr( hb_objSendMsg( hb_stackSelfItem(), "POINTER", 0 ) );
    QString signal = "proxyAuthenticationRequired(QUrl,QAuthenticator*,QString)";
    bool connected = Signals_is_signal_connected( object, signal );
    if( !connected )
    {
      PHB_ITEM codeblock = hb_itemNew( hb_param( 1, HB_IT_BLOCK | HB_IT_SYMBOL ) );
      if( codeblock )
      {
        ret = object->connect( object, SIGNAL(proxyAuthenticationRequired(QUrl,QAuthenticator*,QString)), s, SLOT(proxyAuthenticationRequired(QUrl,QAuthenticator*,QString)) );
        if( ret )
        {
          Signals_connect_signal( object, signal, codeblock ); // se conectado, adiciona
          hb_retl(ret);
  ...
  else if( hb_pcount() == 0 )
  {
    QObject* object = (QObject*) hb_itemGetPtr( hb_objSendMsg( hb_stackSelfItem(), "POINTER", 0 ) );
    QString signal = "proxyAuthenticationRequired(QUrl,QAuthenticator*,QString)";
    ret = object->disconnect(object, SIGNAL(proxyAuthenticationRequired(QUrl,QAuthenticator*,QString)), s, SLOT(proxyAuthenticationRequired(QUrl,QAuthenticator*,QString)) );
    if( ret )
    {
      Signals_disconnect_signal( object, signal );
      hb_retl(true);
