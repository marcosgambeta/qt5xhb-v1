...
{
  if( ISBETWEEN(0,2) && (ISCHAR(1)||HB_ISNIL(1)) && (ISQLOCALE(2)||HB_ISNIL(2)) )
  {
    QResource * obj = new QResource( OPQSTRING(1,QString()), HB_ISNIL(2)? QLocale() : *(QLocale *) Qt5xHb::itemGetPtr(2) );
