...
#define GET_PTR_FROM_SELF(p) QDateTime *p = static_cast<QDateTime *>(Qt5xHb::itemGetPtrStackSelfItem())
...
HB_FUNC_STATIC(QDATETIME_TOTIMESPEC)
{
  ...
  if (obj != NULL) {
    ...
    if (ISNUMPAR(1) && HB_ISNUM(1)) {
#endif
      RQDATETIME(obj->toTimeSpec((Qt::TimeSpec)hb_parni(1)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, NULL, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
    }
...
HB_FUNC_STATIC(QDATETIME_FROMSTRING)
{
  if (ISBETWEEN(1, 2) && ISQSTRING(1) && ISNUMORNIL(2)) {
    ...
    RQDATETIME(QDateTime::fromString(PQSTRING(1), HB_ISNIL(2) ? (Qt::DateFormat)Qt::TextDate : (Qt::DateFormat)hb_parni(2)));
