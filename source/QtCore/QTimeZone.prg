...
#define GET_PTR_FROM_SELF(p) QTimeZone *p = static_cast<QTimeZone *>(Qt5xHb::itemGetPtrStackSelfItem())
...
#if (QT_VERSION >= QT_VERSION_CHECK(5, 2, 0))
    QTimeZone *obj = new QTimeZone(*PQBYTEARRAY(1), PINT(2), PQSTRING(3), PQSTRING(4),
                                   HB_ISNIL(5) ? (QLocale::Country)QLocale::AnyCountry : (QLocale::Country)hb_parni(5),
                                   OPQSTRING(6, QString()));
    Qt5xHb::returnNewObject(obj, true);
#endif
  ...
  if (ISBETWEEN(1, 3) && ISQDATETIME(1) && ISNUMORNIL(2) && ISQLOCALEORNIL(3)) {
    ...
    if (obj != NULL) {
      RQSTRING(obj->displayName(
          *PQDATETIME(1), HB_ISNIL(2) ? (QTimeZone::NameType)QTimeZone::DefaultName : (QTimeZone::NameType)hb_parni(2),
          HB_ISNIL(3) ? QLocale() : *(QLocale *)Qt5xHb::itemGetPtr(3)));
    }
#endif
    ...
    if (obj != NULL) {
      RQSTRING(
          obj->displayName((QTimeZone::TimeType)hb_parni(1),
                           HB_ISNIL(2) ? (QTimeZone::NameType)QTimeZone::DefaultName : (QTimeZone::NameType)hb_parni(2),
                           HB_ISNIL(3) ? QLocale() : *(QLocale *)Qt5xHb::itemGetPtr(3)));
    }
#endif
  } else {
...
HB_FUNC_STATIC(QTIMEZONE_WINDOWSIDTODEFAULTIANAID)
{
  if (ISNUMPAR(1) && ISQBYTEARRAY(1)) {
    ...
    QByteArray *ptr =
        new QByteArray(QTimeZone::windowsIdToDefaultIanaId(*PQBYTEARRAY(1), (QLocale::Country)hb_parni(2)));
    Qt5xHb::createReturnClass(ptr, "QBYTEARRAY", true);
#endif
  } else {
    hb_errRT_BASE(EG_ARG, 3012, NULL, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
