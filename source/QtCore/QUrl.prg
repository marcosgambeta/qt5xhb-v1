...
#define GET_PTR_FROM_SELF(p) QUrl *p = static_cast<QUrl *>(Qt5xHb::itemGetPtrStackSelfItem())
...
// static QByteArray toPercentEncoding( const QString & input, const QByteArray & exclude = QByteArray(), const
