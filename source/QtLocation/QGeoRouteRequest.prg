...
HB_FUNC_STATIC( QGEOROUTEREQUEST_SETFEATUREWEIGHT )
{
  ...
  if( obj )
  {
    int par1 = hb_parni(1);
    int par2 = hb_parni(2);
    obj->setFeatureWeight (  (QGeoRouteRequest::FeatureType) par1,  (QGeoRouteRequest::FeatureWeight) par2 );
  }
  hb_itemReturn( hb_stackSelfItem() );
#endif
}
...
HB_FUNC_STATIC( QGEOROUTEREQUEST_SETSEGMENTDETAIL )
{
  ...
  {
    int par1 = hb_parni(1);
    obj->setSegmentDetail (  (QGeoRouteRequest::SegmentDetail) par1 );
  }
  hb_itemReturn( hb_stackSelfItem() );
#endif
}
...
HB_FUNC_STATIC( QGEOROUTEREQUEST_SETMANEUVERDETAIL )
{
  ...
  {
    int par1 = hb_parni(1);
    obj->setManeuverDetail (  (QGeoRouteRequest::ManeuverDetail) par1 );
  }
  hb_itemReturn( hb_stackSelfItem() );
#endif
}
