...
#define GET_PTR_FROM_SELF(p)                                                                                           \
  QGeoRoutingManager *p = qobject_cast<QGeoRoutingManager *>(Qt5xHb::getQObjectPointerFromSelfItem())
...
#define CONNECT_SIGNAL(signal) QGeoRoutingManagerSlots_connect_signal(signal, signal)
