...
#define GET_PTR_FROM_SELF(p)                                                                                           \
  QPlaceManagerEngine *p = qobject_cast<QPlaceManagerEngine *>(Qt5xHb::getQObjectPointerFromSelfItem())
...
#define CONNECT_SIGNAL(signal) QPlaceManagerEngineSlots_connect_signal(signal, signal)
