...
CLASS QMediaBindableInterface
   ...
   DATA pointer
   DATA class_id INIT Class_Id_QMediaBindableInterface
...
{
#if (QT_VERSION >= QT_VERSION_CHECK(5,0,0))
  QMediaBindableInterface * obj = (QMediaBindableInterface *) hb_itemGetPtr( hb_objSendMsg( hb_stackSelfItem(), "POINTER", 0 ) );
  if( obj )
  {
    delete obj;
    obj = NULL;
