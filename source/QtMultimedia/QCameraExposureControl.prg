...
#endif
      RQVARIANT(obj->actualValue((QCameraExposureControl::ExposureParameter)hb_parni(1)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
...
HB_FUNC_STATIC(QCAMERAEXPOSURECONTROL_REQUESTEDVALUE)
{
  ...
  if (obj != NULL) {
    ...
    if (ISNUMPAR(1) && HB_ISNUM(1)) {
#endif
      RQVARIANT(obj->requestedValue((QCameraExposureControl::ExposureParameter)hb_parni(1)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, NULL, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
    }
