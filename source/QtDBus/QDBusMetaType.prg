...
CLASS QDBusMetaType
   ...
   DATA pointer
   DATA class_id INIT Class_Id_QDBusMetaType
...
{
  QDBusMetaType * obj = (QDBusMetaType *) hb_itemGetPtr( hb_objSendMsg( hb_stackSelfItem(), "POINTER", 0 ) );
  if( obj )
  {
    delete obj;
    obj = NULL;
...
HB_FUNC_STATIC( QDBUSMETATYPE_SIGNATURETOTYPE )
{
  ...
  hb_retni( QDBusMetaType::signatureToType (  (const char *) par1 ) );
}
