...
{
#if (QT_VERSION >= QT_VERSION_CHECK(5, 8, 0))
  QCanBusDeviceSlots_connect_signal("errorOccurred(QCanBusDevice::CanBusError)",
...
{
#if (QT_VERSION >= QT_VERSION_CHECK(5, 8, 0))
  QCanBusDeviceSlots_connect_signal("stateChanged(QCanBusDevice::CanBusDeviceState)",
