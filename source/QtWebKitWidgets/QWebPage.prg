...
{
  QWebPage * obj = (QWebPage *) _qtxhb_itemGetPtrStackSelfItem();
  if( obj )
  {
    int par1 = hb_parni(1);
...
HB_FUNC_STATIC( QWEBPAGE_EXTENSION )
{
  ...
  {
    int par1 = hb_parni(1);
    QWebPage::ExtensionOption * par2 = (QWebPage::ExtensionOption *) _qtxhb_itemGetPtr(2);
    QWebPage::ExtensionReturn * par3 = ISNIL(3)? 0 : (QWebPage::ExtensionReturn *) _qtxhb_itemGetPtr(3);
...
HB_FUNC_STATIC( QWEBPAGE_SETPLUGINFACTORY )
{
  ...
  if( obj )
  {
    QWebPluginFactory * par1 = (QWebPluginFactory *) _qtxhb_itemGetPtr(1);
...
HB_FUNC_STATIC( QWEBPAGE_SWALLOWCONTEXTMENUEVENT )
{
  ...
  if( obj )
  {
    QContextMenuEvent * par1 = (QContextMenuEvent *) _qtxhb_itemGetPtr(1);
