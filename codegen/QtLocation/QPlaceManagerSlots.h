...
$signal=5,4,0|void categoryAdded( const QPlaceCategory & category, const QString & parentId )
$signal=5,4,0|void categoryUpdated( const QPlaceCategory & category, const QString & parentId )
$signal=5,4,0|void categoryRemoved( const QString & categoryId, const QString & parentId )
